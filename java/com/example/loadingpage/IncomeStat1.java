...
public class IncomeStat1 extends AppCompatActivity {
    PieChart pieChart;
    ListView listView;
    //TODO:
    // get all categories and all incomes
    // these categories amount will later on be used for pie chart and listView
    String[] itemsCategory = {"Salary", "Bonus", "Lottery"}; //get categories
    String[] itemsAmount = {"2000", "35", "500"}; // get categories amount
