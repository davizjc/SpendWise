...
public class landingpagelastmonth2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.landingpagelastmonth2);
        ...
        Button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(landingpagelastmonth2.this, MainActivity.class);
    ...
    public void onAddExpenseClick (View view) {
        Intent intent = new Intent(getApplicationContext(), addrecord1.class);
        startActivity(intent);
    }
}
